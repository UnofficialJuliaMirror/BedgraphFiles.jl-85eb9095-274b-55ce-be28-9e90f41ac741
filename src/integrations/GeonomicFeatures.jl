...
function Base.convert(::Type{Vector{Bedgraph.Record}}, data::Union{GenomicFeatures.IntervalCollection, Vector{GenomicFeatures.Interval}}) :: Vector{Bedgraph.Record}
